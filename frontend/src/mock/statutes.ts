...
export const statuteOf = (statuteVersionId: number): Statute | undefined =>
STATUTES.find((statute) => statute.statuteVersionId === statuteVersionId);
